...
export class ComboMode {
  ...
  public renderCombo() {
    ...
    if (!this.comboStatusBarItem) {
      this.comboStatusBarItem = window.createStatusBarItem(StatusBarAlignment.Left);
    }
  ...
  public renderComboRecord() {
    ...
    if (!this.recordStatusBarItem) {
      this.recordStatusBarItem = window.createStatusBarItem(StatusBarAlignment.Left);
    }
    ...
    this.recordStatusBarItem.text = `${this.newRecord ? 'New Recode': 'Recode'}: ${this.currentComboRecord}`;
